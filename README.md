...
| **v10** | 2026-06-08 | ♿ UI 人因工程：按钮最小 28px + 抓取区 20px + 可访问性改进 + 键盘导航 |
| **v9** | 2026-06-07 | 🧩 前端模块化 + 题目搜索 + 代码历史（10 条） + 系统主题跟随 |
| **v1-v8** | 2026-05~06 | 🏗️ 核心平台：TCC 编译运行 + 144 题判题引擎 + 36 课系统课程 + 代码可视化模拟器 + 桌面壳 |

## 🗺️ 未来计划

- [ ] v4.0: 代码自动补全 + 实时错误提示
- [ ] v5.0: 学习路径推荐（"每日一题"）+ 成就系统
- [ ] v6.0: 移动端 PWA 适配
